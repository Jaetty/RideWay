...
class BoardListAdapter(var data : List<BoardDataResponse.Content>) : RecyclerView.Adapter<BoardListAdapter.MyViewHolder>(){
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.bind.boardListLayout.setOnClickListener{
            ...
            intent.putExtra("boardNum",content.boardId.toString())
